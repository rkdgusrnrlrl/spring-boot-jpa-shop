window.onload = function () { // wait for load in a dumb way because B-0
  ...
  function showError(msg, err) {
    $('<div no="bsCustomizerAlert" class="bs-customizer-alert">\
        <div class="container">\
  ...
  function createGist(configData) {
    ...
    .success(function(result) {
      history.replaceState(false, document.title, window.location.origin + window.location.pathname + '?no=' + result.id)
    })
    .error(function(err) {
